window.PI_STATUS = {
  "as_of": "2026-09-03",
  "as_of_utc": "2026-09-03T00:05:12Z",
  ...
  "sources": {
    "git_log_since": "2026-09-02",
    "iso_week": "2026-W36",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-03 cannot hide today"
  },
  "weekly": {
    "label": "2026-W36",
    "start": "2026-08-31",
    ...
    "still_open": [
      {
        ...
        "evidence": "list-cloud-agents returned this cron (bc-b1bc2328), 9/02 bc-7de4187d, 9/01 bc-76a61999, 8/31 bc-f631c354, 8/30 bc-eb481f27, 8/29 bc-8dc1a78f, 8/28 bc-ede78703, 8/27 bc-d4995744, 8/26 bc-45e4c56a, plus internal Search 8/28 transcript for dashboard / Find original ops dashboard schema / Summarize yesterday log bot; desktop/web/local sources returned 0"
      },
      {
        "item": "Daily log PRs #1, #3, #4, #5, #6, #7, and #8 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; #3 cursor/property-intel-daily-log-299e DRAFT; #4 cursor/property-intel-daily-log-0704 DRAFT; #5 cursor/property-intel-daily-log-3f6c DRAFT; #6 cursor/property-intel-daily-log-866d DRAFT; #7 cursor/property-intel-daily-log-0d29 DRAFT; #8 cursor/property-intel-daily-log-3473 DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. satellite.gs + critique-api.gs changed in d688a65; shared.gs in 4b35668; critique-api.gs again in da8dedf; MOCKINGBIRD row 277 is the first check after a real deploy.",
      "Public data/*.json is sync-owned. Last Sync/Publish on origin/main is 187a608 Sync Drone (2026-08-28T14:03:30Z). 4b35668 added 3 data/gis/{id}.json (GIS facts; writer gisFileForSync_). No satellite/plane/drone data/ sync after 187a608.",
    ...
    "pipelines": [
      ...
      },
      {
        ...
        "evidence": "element-review.html BUILD v6.8.20 on HEAD (da8dedf Show pins). satellite.gs copy changed in d688a65; file copy is not a deploy. No satellite.gs deploy evidence 2026-08-29..2026-09-03."
      },
      {
        "id": "golf",
    ...
    "in_progress": [
      {
        ...
        "evidence": "Draft PRs #1, #3, #4, #5, #6, #7, #8. origin/main has no docs/ops."
      },
      {
      ...
      },
      {
        ...
        "evidence": "a8b3ceb..8b1d0d4 committed golf.gs/config.gs/menu.gs/critique-api.gs copies. Editor-save is not a deploy. No deployment-version evidence in this clone."
      },
      {
        "item": "satellite.gs / critique-api.gs deploy unverified after 9/01 evening + 9/02 copies",
        "evidence": "d688a65 copied satellite.gs and critique-api.gs; da8dedf copied critique-api.gs. File copies are not a deploy. MOCKINGBIRD row 277 is the first check after a real satellite.gs deploy."
      }
    ]
  },
  "days": [
  ...
  "board": {
    ...
    "summary": "Element Review v6.8.20 and hub 1.8.14 on main (Show pins + GIS facts on Private); golf still v1.0.4; Lane parcels published; photo transport and EagleView access still block scale-out.",
    "as_of": "2026-09-03",
    "last_write": "2026-09-03 00:05 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-03"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-03 (was 20 on 2026-08-25)"
      },
      {
