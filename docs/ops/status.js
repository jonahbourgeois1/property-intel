window.PI_STATUS = {
  "as_of": "2026-09-18",
  "as_of_utc": "2026-09-18T00:04:33Z",
  ...
  "sources": {
    ...
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-18 cannot hide today"
  },
  "weekly": {
    "label": "2026-W38",
    "start": "2026-09-14",
  ...
  "board": {
    ...
    "summary": "Captured three 2026-09-17 afternoon ships after the 9/17 00:04 UTC cron. Head now ba89172. f70f275 estimated Gud Cultures camera pins (cameras/json count stays 3). f2f9f2f hub 1.8.25\u21921.8.28 / live-viewer 1.1.5\u21921.1.8 last-clip stills. ba89172 hub 1.8.28\u21921.8.31 / live-viewer 1.1.8\u21921.1.11 hung-MJPEG snapshot poll. ER v6.8.20, golf v1.0.4, Nearmap review v1.7.18 / viewer v1.1.16. ISO week 2026-W38. Lane 332; satellite 506; plane 22; drone 134; nearmap 1; responder-drone 137; cameras/json 3. completion % null. Photo transport and EagleView access still block scale-out (no new evidence).",
    "as_of": "2026-09-18",
    "last_write": "2026-09-18 00:04 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-18"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-18 (was 20 on 2026-08-25)"
      },
      {
