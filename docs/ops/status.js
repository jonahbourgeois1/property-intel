window.PI_STATUS = {
  "as_of": "2026-08-29",
  "as_of_utc": "2026-08-29T00:16:28Z",
  ...
  "sources": {
    "git_log_since": "2026-08-28",
    "iso_week": "2026-W35",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-08-29 cannot hide today"
  },
  "weekly": {
    "label": "2026-W35",
    "start": "2026-08-24",
    ...
    "shipped": [
      {
        ...
        "sha": "53346bd",
        "message": "Bump hub to 1.8.12 so the Community iframe drops its cached v2.3.4 hoa-viewer.",
        "evidence": "HUB_BUILD = '1.8.12' in js/vyanet-viewer/property.js"
      },
      {
        "date": "2026-08-28",
        "sha": "e3952cf",
        "message": "Stop Community from 404ing on the deleted monolithic index.json.",
        "evidence": "hoa-viewer.html loads data/index/{id}.json (satellite fallback); old data/index.json fetch removed"
      },
      {
        "date": "2026-08-28",
        "sha": "260c239",
        "message": "Match 2D camera pins to 3D: same popup, live LEDs, and 72-hour clip dots.",
        "evidence": "hub 1.8.11 in this commit; shared.gs copy (not a deploy); deleted duplicate cameras json 8eea64e5; 2 json files on HEAD"
      },
      {
        "date": "2026-08-28",
        "sha": "b44575a",
        "message": "Let reviewers pin outside the nadir crop and open Google Earth from Element Review.",
        "evidence": "element-review BUILD v6.8.10; satellite.gs/plane.gs/drone-test.gs/critique-api.gs/shared.gs copies (not a deploy)"
      },
      {
        "date": "2026-08-28",
        "sha": "cfde3ab",
        "message": "Stop Lane road leftovers from painting as the property line.",
        "evidence": "nadir-geo.js MAPTAXLOT then TAXLOT; merged to main as e4863fb"
      },
      {
        "date": "2026-08-28",
        "sha": "187a608",
        "message": "Sync Drone — 8/28/2026, 9:03:29 AM",
        "evidence": "sync-owned data/; plus six Publish Responder Intel commits ee91147..47def97"
      },
      {
        "date": "2026-08-27",
        "sha": "5c79788",
        "message": "Merge pull request #2 from jonahbourgeois1/cursor/vyanet-viewer-gate-home",
        "evidence": "hub 1.6.4 lineage on main; cursor/vyanet-viewer-gate-home has no commits not on main"
      },
      {
        "date": "2026-08-27",
        "sha": "df985c1",
        "message": "Hub 1.7.3: show Eugene cameras on the live hub and join four CHEKT feeds to stills.",
        "evidence": "HUB_BUILD = '1.7.3' in js/vyanet-viewer/property.js"
      },
      {
        "date": "2026-08-27",
        "sha": "9a754fb",
        "message": "Hub 1.7.2: Eugene cameras, FR 3D pins, CHEKT live by address.",
        "evidence": "viewer + .gs copies (not a deploy)"
      },
      {
        "date": "2026-08-27",
        "sha": "11c0394",
        "message": "Put camera metadata back in data/cameras/json/, one file per property.",
        "evidence": "settled path data/cameras/json/{id}.json; 3 json files on HEAD; stills from 6e693f0"
      },
      {
        "date": "2026-08-27",
        "sha": "a302173",
        "message": "Redraw element-review pins immediately after rerun so the map updates without a page reload.",
        "evidence": "element-review BUILD v6.8.8"
      },
      {
        "date": "2026-08-27",
        "sha": "9442d72",
        "message": "Let drone-test element review georeference CloudFront nadirs and identify the row by taxlot.",
        "evidence": "element-review.html + nadir-geo.js"
      },
      {
        "date": "2026-08-27",
        "sha": "91556e6",
        "message": "Add Lane County lot-line tiles and teach viewers both county grids.",
        "evidence": "332 data/parcels/lane_*.geojson files"
      },
      {
        "date": "2026-08-27",
        "sha": "1f02d1b",
        "message": "Stop drawing the element-review pin-range box, allow reviewer duplicate pins, and raise the school cap to 20.",
        "evidence": "SCHOOL_PIN_LIMIT=20; SAT_MAX_PINS stays 12 in satellite.gs copy (not a deploy)"
      },
      {
        "date": "2026-08-27",
        "sha": "0b51828",
        "message": "Sync Row — Vyanet Eugene — 8/27/2026, 2:47:40 PM",
        "evidence": "sync-owned data/; plus six Sync drone-test commits e614910..0ef3f6f"
      },
      {
        "date": "2026-08-26",
        "sha": "06c9714",
        "message": "Update pins-catalog.json",
        "evidence": "pin_count 239 -> 256; role= on all 256 pins"
      },
      {
        "date": "2026-08-25",
        "sha": "8662883",
        "message": "Identify element-review critiques by site_no instead of address.",
        "evidence": "element-review BUILD v6.8.2; apps scripts/*.gs copies (not a deploy)"
      },
      {
        "date": "2026-08-24",
        "sha": "7cbe86e",
        "message": "Add a thin Vyanet Viewer hub that iframes the existing 3D and satellite pages.",
        "evidence": "then-main hub BUILD 1.0.3; later superseded on main by 1.7.3"
      },
      {
        "date": "2026-08-24",
        "sha": "86e00ef",
        "message": "Sync drone-test — 8/24/2026, 3:26:05 PM",
        "evidence": "Apps Script-style data/ sync"
      },
      {
        "date": "2026-08-24",
        "sha": "3c17989",
        "message": "Add agent onboarding: CLAUDE.md, AGENTS.md, Cursor rules; replace README stub",
        "evidence": "v1 onboarding docs"
      }
    ],
    "still_open": [
      {
        "item": "Chat direction not visible to Log Bot",
        "evidence": "list-cloud-agents returned this cron (bc-8dc1a78f), 8/28 bc-ede78703, 8/27 bc-d4995744, plus internal Summarize yesterday log bot"
      },
      {
        "item": "Daily log PRs #1 and #3 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; #3 cursor/property-intel-daily-log-299e DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. satellite.gs copied in b44575a; shared.gs copied in b44575a and 260c239. No satellite.gs deploy evidence on 2026-08-29; MOCKINGBIRD row 277 is the first check after a real deploy.",
      "Public data/*.json is sync-owned (six responder-intel publishes + Sync Drone + camera json delete/edit on 2026-08-28).",
