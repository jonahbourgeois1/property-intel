window.PI_STATUS = {
  "as_of": "2026-09-04",
  "as_of_utc": "2026-09-04T00:06:58Z",
  ...
  "sources": {
    "git_log_since": "2026-09-03",
    "iso_week": "2026-W36",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-04 cannot hide today"
  },
  "weekly": {
    "label": "2026-W36",
    "start": "2026-08-31",
    ...
    "still_open": [
      {
        ...
        "evidence": "list-cloud-agents returned this cron (bc-7fb90f35), 9/03 bc-b1bc2328, 9/02 bc-7de4187d, 9/01 bc-76a61999, 8/31 bc-f631c354, 8/30 bc-eb481f27, 8/29 bc-8dc1a78f, 8/28 bc-ede78703, 8/27 bc-d4995744, 8/26 bc-45e4c56a, plus internal Search 8/28 transcript for dashboard / Find original ops dashboard schema / Summarize yesterday log bot; desktop/web/local sources returned 0"
      },
      {
        "item": "Daily log PRs #1, #3, #4, #5, #6, #7, #8, and #9 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; #3 cursor/property-intel-daily-log-299e DRAFT; #4 cursor/property-intel-daily-log-0704 DRAFT; #5 cursor/property-intel-daily-log-3f6c DRAFT; #6 cursor/property-intel-daily-log-866d DRAFT; #7 cursor/property-intel-daily-log-0d29 DRAFT; #8 cursor/property-intel-daily-log-3473 DRAFT; #9 cursor/property-intel-daily-log-4466 DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
    ...
    "pipelines": [
      ...
      },
      {
        ...
        "evidence": "element-review.html BUILD v6.8.20 on HEAD (da8dedf Show pins). satellite.gs copy changed in d688a65; file copy is not a deploy. No satellite.gs deploy evidence 2026-08-29..2026-09-04. No origin/main commits after da8dedf."
      },
      {
        "id": "golf",
    ...
    "in_progress": [
      {
        ...
        "evidence": "Draft PRs #1, #3, #4, #5, #6, #7, #8, #9. origin/main has no docs/ops."
      },
      {
  ...
  "board": {
    ...
    "as_of": "2026-09-04",
    "last_write": "2026-09-04 00:06 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-04"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-04 (was 20 on 2026-08-25)"
      },
      {
        "label": "Ranked open items",
        "value": "17",
        "sub": "still open of 18 listed",
        "evidence": "2026-08-25 board. Original 18-item list is not in this clone; no evidence those items closed. Recount 2026-09-03 unchanged."
      },
      {
        "label": "EagleView access",
        "value": "Not granted",
        "sub": "30-day eval clock has not started",
        "evidence": "2026-08-25 board; no grant file in this checkout. Recount 2026-09-03 unchanged."
      }
    ],
    "pipelines": [
      {
