window.PI_STATUS = {
  "as_of": "2026-09-05",
  "as_of_utc": "2026-09-05T00:09:08Z",
  "repo": "jonahbourgeois1/property-intel",
  "ref": "origin/main",
  "head": {
    "sha": "da8dedf2fd59141b6bc39180102d65e71cd53c4a",
    "short": "da8dedf",
    "message": "Add a Show pins dropdown so reviewers can compare Bedrock and prior rounds (v6.8.20).",
    "author_date": "2026-09-02T21:43:48Z"
  },
  "sources": {
    "git_log_since": "2026-09-04",
    "iso_week": "2026-W36",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-05 cannot hide today"
  },
  "weekly": {
    "label": "2026-W36",
    "start": "2026-08-31",
    ...
    "shipped": [
      {
        "sha": "064658ba32fcf340eed0e920e67cc3fab5316eab",
        "short": "064658b",
        "message": "Move property CHEKT under Private and add an empty Community Live slot.",
        "author_date": "2026-08-31T17:19:37Z",
        "note": "Hub 1.8.13. Captured after 2026-08-31 00:06 UTC log. Author-date 2026-08-31 12:19 -0500."
      },
      {
        "sha": "a8b3ceba76dc24168319d8e802b213de377f49a1",
        "short": "a8b3ceb",
        "message": "Add a sheet-only golf review pipeline with lat/lng pins.",
        "author_date": "2026-09-01T18:19:49Z",
        "note": "golf-review.html BUILD v1.0.0. Independent 150-pin seed (ids 1001-1150). GOLF_MAX_PINS=200 in config.gs copy. .gs copies are not a deploy. Captured after 2026-09-01 00:06 UTC log. Author-date 2026-09-01 13:19 -0500."
      },
      {
        "sha": "30d546a106d1d7bfc1d506f745cf87f44a45064c",
        "short": "30d546a",
        "message": "Show a yellow nadir pin at the geocoded golf address.",
        "author_date": "2026-09-01T18:39:53Z",
        "note": "golf-review.html BUILD v1.0.1. Also apply Elements Reviewed checkboxes on an empty Golf tab. Author-date 2026-09-01 13:39 -0500."
      },
      {
        "sha": "de7ad605f4b06ed0a1cfe77638f5a87575fbe68e",
        "short": "de7ad60",
        "message": "Use a blue dot for the golf address and show a spinner until map tiles load.",
        "author_date": "2026-09-01T18:44:22Z",
        "note": "golf-review.html BUILD v1.0.2. Author-date 2026-09-01 13:44 -0500."
      },
      {
        "sha": "261711455ed9efe830f7ac84362c0ff8fe1d6ee1",
        "short": "2617114",
        "message": "Start the golf map from URL coordinates instead of waiting on Apps Script.",
        "author_date": "2026-09-01T22:11:55Z",
        "note": "golf-review.html BUILD v1.0.3. Author-date 2026-09-01 17:11 -0500."
      },
      {
        "sha": "8b1d0d45693bc160fa384cf7c8688bfd335f7e43",
        "short": "8b1d0d4",
        "message": "Keep duplicate catalog pins as separate instances when adding or dragging.",
        "author_date": "2026-09-01T23:06:41Z",
        "note": "element-review.html BUILD v6.8.11; golf-review.html BUILD v1.0.4. satellite.gs/critique-api.gs copies are not a deploy. Author-date 2026-09-01 18:06 -0500."
      },
      {
        "sha": "d688a6517b91cae89d450a4c487fa1adbc59ed89",
        "short": "d688a65",
        "message": "Key pin identity on the marker number, not catalog id, so duplicate pins survive moves and removes.",
        "author_date": "2026-09-02T00:02:30Z",
        "note": "element-review.html BUILD v6.8.13 (from v6.8.11; no v6.8.12 commit). critique-api.gs/satellite.gs copies are not a deploy. Captured after 2026-09-02 00:01 UTC log. Author-date 2026-09-01 19:02 -0500."
      },
      {
        "sha": "be175c0a6d861940cfdc84aebadc4a3c8c869946",
        "short": "be175c0",
        "message": "element-review v6.8.14: surface stale server build on submit (min v6.8.2 for duplicate-pin identity)",
        "author_date": "2026-09-02T00:12:57Z",
        "note": "element-review.html BUILD v6.8.14. Author-date 2026-09-01 19:12 -0500."
      },
      {
        "sha": "4987718fa93ffb02888262094249dd1ac265c607",
        "short": "4987718",
        "message": "Add DPC Prime to the reviewer dropdown and ship sandbox=1 routing (v6.8.17).",
        "author_date": "2026-09-02T21:02:51Z",
        "note": "element-review.html BUILD v6.8.17. Header dates sandbox=1 to v6.8.15; no v6.8.15/v6.8.16 commits on main. Author-date 2026-09-02 16:02 -0500."
      },
      {
        "sha": "f1b002d5b359fa2d88c1f105155fad41cf51e848",
        "short": "f1b002d",
        "message": "Rename the fifth reviewer to DPC: (v6.8.18).",
        "author_date": "2026-09-02T21:11:13Z",
        "note": "element-review.html BUILD v6.8.18. Label has to match the critique sheet. Author-date 2026-09-02 16:11 -0500."
      },
      {
        "sha": "6252628ac58e044cd4f309622d668fefef72c465",
        "short": "6252628",
        "message": "Rename the fifth reviewer to DPC' (v6.8.19).",
        "author_date": "2026-09-02T21:13:05Z",
        "note": "element-review.html BUILD v6.8.19. Apostrophe, not a colon. Author-date 2026-09-02 16:13 -0500."
      },
      {
        "sha": "4b35668c300805e52b9e931278414a344333d3cf",
        "short": "4b35668",
        "message": "Show known GIS property facts on the Private rail.",
        "author_date": "2026-09-02T21:22:27Z",
        "note": "HUB_BUILD 1.8.14. js/vyanet-viewer/gis-facts.js plus 3 data/gis/{id}.json. Writer gisFileForSync_; not a Sync/Publish. shared.gs copy is not a deploy. Author-date 2026-09-02 16:22 -0500."
      },
      {
        "sha": "da8dedf2fd59141b6bc39180102d65e71cd53c4a",
        "short": "da8dedf",
        "message": "Add a Show pins dropdown so reviewers can compare Bedrock and prior rounds (v6.8.20).",
        "author_date": "2026-09-02T21:43:48Z",
        "note": "element-review.html BUILD v6.8.20. critique-api.gs copy is not a deploy. Author-date 2026-09-02 16:43 -0500."
      }
    ],
    "still_open": [
      {
        "item": "Chat direction not visible to Log Bot",
        "evidence": "list-cloud-agents returned this cron (bc-5c01f7f0), 9/04 bc-7fb90f35, 9/03 bc-b1bc2328, 9/02 bc-7de4187d, 9/01 bc-76a61999, 8/31 bc-f631c354, 8/30 bc-eb481f27, 8/29 bc-8dc1a78f, 8/28 bc-ede78703, 8/27 bc-d4995744, 8/26 bc-45e4c56a, plus internal Search 8/28 transcript for dashboard / Find original ops dashboard schema / Summarize yesterday log bot; desktop/web/local sources returned 0"
      },
      {
        "item": "Daily log PRs #1, #3, #4, #5, #6, #7, #8, #9, and #10 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; #3 cursor/property-intel-daily-log-299e DRAFT; #4 cursor/property-intel-daily-log-0704 DRAFT; #5 cursor/property-intel-daily-log-3f6c DRAFT; #6 cursor/property-intel-daily-log-866d DRAFT; #7 cursor/property-intel-daily-log-0d29 DRAFT; #8 cursor/property-intel-daily-log-3473 DRAFT; #9 cursor/property-intel-daily-log-4466 DRAFT; #10 cursor/property-intel-daily-log-b7f8 DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. No .gs copies on origin/main after da8dedf (2026-09-02). Last satellite.gs copy remains d688a65; MOCKINGBIRD row 277 is the first check after a real deploy.",
      "Public data/*.json is sync-owned. Last Sync/Publish on origin/main is 187a608 Sync Drone (2026-08-28T14:03:30Z). 4b35668 added 3 data/gis/{id}.json (GIS facts; writer gisFileForSync_). No satellite/plane/drone data/ sync after 187a608. No origin/main commits after da8dedf.",
    ...
    "pipelines": [
      {
        ...
        "status": "on main",
        "evidence": "origin/main da8dedf; HUB_BUILD 1.8.14; element-review BUILD v6.8.20; golf-review BUILD v1.0.4"
      },
      {
        "id": "sync",
        "name": "Apps Script \u2192 GitHub data sync",
        "status": "last Sync/Publish 2026-08-28; GIS facts committed 2026-09-02",
        "evidence": "187a608 Sync Drone; six Publish Responder Intel ee91147..47def97. 4b35668 added 3 data/gis/{id}.json (not a Sync/Publish). Editor-save is not a deploy."
      },
      {
        "id": "satellite",
        "name": "Satellite Pass 1 / review / Pass 2",
        "status": "viewers on main; deploy unverified",
        "evidence": "element-review.html BUILD v6.8.20 on HEAD (da8dedf Show pins). satellite.gs copy changed in d688a65; file copy is not a deploy. No satellite.gs deploy evidence 2026-08-29..2026-09-05. No origin/main commits after da8dedf."
      },
      {
        "id": "golf",
        "name": "Golf review (sheet-only)",
        "status": "on main; Apps Script deploy unverified",
        "evidence": "golf-review.html BUILD v1.0.4 on origin/main 8b1d0d4; unchanged by d688a65..da8dedf. Seed 150 pins ids 1001-1150; GOLF_MAX_PINS=200 in config.gs copy. golf.gs header: no data/golf/, never merge into pins-catalog.json. .gs copies are not a deploy."
      },
      {
        "id": "plane",
      ...
      },
      {
        ...
        "name": "Live CHEKT",
        "status": "on main",
        "evidence": "4b35668 hub 1.8.14: GIS facts on Private rail; property CHEKT still under Private; Community Live empty slot. live-viewer.html still on origin/main."
      },
      {
        "id": "photo",
        "name": "Photo intake",
    ...
    "in_progress": [
      {
        ...
        "evidence": "Draft PRs #1, #3, #4, #5, #6, #7, #8, #9, #10. origin/main has no docs/ops."
      },
      {
      ...
      },
      {
        ...
        "evidence": "a8b3ceb..8b1d0d4 committed golf.gs/config.gs/menu.gs/critique-api.gs copies. Editor-save is not a deploy. No deployment-version evidence in this clone. No golf commits after 8b1d0d4."
      },
      {
        "item": "satellite.gs / critique-api.gs deploy unverified after 9/01 evening + 9/02 copies",
        "evidence": "d688a65 copied satellite.gs and critique-api.gs; da8dedf copied critique-api.gs. File copies are not a deploy. No origin/main commits after da8dedf. MOCKINGBIRD row 277 is the first check after a real satellite.gs deploy."
      }
    ]
  },
  "days": [
  ...
  "board": {
    ...
    "summary": "Nothing shipped on origin/main after da8dedf. Element Review v6.8.20 and hub 1.8.14 still HEAD; golf still v1.0.4; Lane 332 tiles; photo transport and EagleView access still block scale-out.",
    "as_of": "2026-09-05",
    "last_write": "2026-09-05 00:09 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-05"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-05 (was 20 on 2026-08-25)"
      },
      {
        "label": "Ranked open items",
        "value": "17",
        "sub": "still open of 18 listed",
        "evidence": "2026-08-25 board. Original 18-item list is not in this clone; no evidence those items closed. Recount 2026-09-05 unchanged."
      },
      {
        "label": "EagleView access",
        "value": "Not granted",
        "sub": "30-day eval clock has not started",
        "evidence": "2026-08-25 board; no grant file in this checkout. Recount 2026-09-05 unchanged."
      }
    ],
    "pipelines": [
      {
        ...
        "items": [
          {
            ...
            "note": "origin/main 4b35668; HUB_BUILD 1.8.14; GIS facts on Private rail; property CHEKT under Private; Community Live empty slot; live-viewer.html on main."
          },
          {
            "status": "done",
            "label": "DONE",
            "title": "Element Review outside-crop pins + Earth",
            "note": "element-review.html BUILD v6.8.20 on HEAD da8dedf (Show pins + DPC' + sandbox=1; duplicate identity is marker number since d688a65)."
          },
          {
            "status": "in_progress",
            "label": "IN PROGRESS",
            "title": "Golf review (sheet-only)",
            "note": "golf-review.html BUILD v1.0.4 on origin/main 8b1d0d4; unchanged by d688a65..da8dedf. Seed 150 pins ids 1001-1150; GOLF_MAX_PINS=200 in the config.gs copy. .gs copies are not a deploy. No data/golf/."
          },
          {
            "status": "blocked",
            "label": "BLOCKED",
