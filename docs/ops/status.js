window.PI_STATUS = {
  "as_of": "2026-09-06",
  "as_of_utc": "2026-09-06T00:17:22Z",
  ...
  "sources": {
    "git_log_since": "2026-09-05",
    "iso_week": "2026-W36",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-06 cannot hide today"
  },
  "weekly": {
    "label": "2026-W36",
    "start": "2026-08-31",
    ...
    "pipelines": [
      ...
      },
      {
        ...
        "evidence": "element-review.html BUILD v6.8.20 on HEAD (da8dedf Show pins). satellite.gs copy changed in d688a65; file copy is not a deploy. No satellite.gs deploy evidence 2026-08-29..2026-09-06. No origin/main commits after da8dedf."
      },
      {
        "id": "golf",
    ...
    "in_progress": [
      {
        ...
        "evidence": "Draft PRs #1, #3, #4, #5, #6, #7, #8, #9, #10, #11. origin/main has no docs/ops."
      },
      {
  ...
  "board": {
    ...
    "as_of": "2026-09-06",
    "last_write": "2026-09-06 00:17 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-06"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-06 (was 20 on 2026-08-25)"
      },
      {
        "label": "Ranked open items",
        "value": "17",
        "sub": "still open of 18 listed",
        "evidence": "2026-08-25 board. Original 18-item list is not in this clone; no evidence those items closed. Recount 2026-09-06 unchanged."
      },
      {
        "label": "EagleView access",
        "value": "Not granted",
        "sub": "30-day eval clock has not started",
        "evidence": "2026-08-25 board; no grant file in this checkout. Recount 2026-09-06 unchanged."
      }
    ],
    "pipelines": [
      {
