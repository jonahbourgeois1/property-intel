window.PI_STATUS = {
  "as_of": "2026-08-30",
  "as_of_utc": "2026-08-30T00:20:58Z",
  ...
  "sources": {
    "git_log_since": "2026-08-29",
    "iso_week": "2026-W35",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-08-30 cannot hide today"
  },
  "weekly": {
    "label": "2026-W35",
    "start": "2026-08-24",
    ...
    "still_open": [
      {
        ...
        "evidence": "list-cloud-agents returned this cron (bc-eb481f27), 8/29 bc-8dc1a78f, 8/28 bc-ede78703, 8/27 bc-d4995744, 8/26 bc-45e4c56a, plus internal Summarize yesterday log bot; desktop/web/local sources returned 0"
      },
      {
        "item": "Daily log PRs #1, #3, and #4 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; #3 cursor/property-intel-daily-log-299e DRAFT; #4 cursor/property-intel-daily-log-0704 DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. No .gs copies and no satellite.gs deploy evidence on 2026-08-30; MOCKINGBIRD row 277 is the first check after a real deploy.",
