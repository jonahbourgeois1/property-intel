window.PI_STATUS = {
  ...
  "weekly": {
    ...
    "still_open": [
      ...
      {
        "item": "Daily log PRs #1, #3, #4, and #5 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; #3 cursor/property-intel-daily-log-299e DRAFT; #4 cursor/property-intel-daily-log-0704 DRAFT; #5 cursor/property-intel-daily-log-3f6c DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
