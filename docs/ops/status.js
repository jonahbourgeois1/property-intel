window.PI_STATUS = {
  "as_of": "2026-08-27",
  "as_of_utc": "2026-08-27T15:12:00Z",
  ...
  "sources": {
    "git_log_since": "2026-08-24",
    "iso_week": "2026-W35",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js from 8/25 cannot hide 8/26-8/27"
  },
  "weekly": {
    "label": "2026-W35",
    "start": "2026-08-24",
    ...
    "still_open": [
      {
        ...
        "evidence": "origin/cursor/vyanet-viewer-gate-home @ 161a860; main BUILD 1.0.3"
      },
      {
        "item": "Chat direction not visible to Log Bot",
        "evidence": "list-cloud-agents returned only Log Bot automations"
      }
    ],
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. No satellite.gs deploy evidence on 2026-08-27; MOCKINGBIRD row 277 not checked.",
