window.PI_STATUS = {
  "as_of": "2026-09-23",
  "as_of_utc": "2026-09-23T00:04:52Z",
  ...
  "sources": {
    ...
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-23 cannot hide today"
  },
  "weekly": {
    "label": "2026-W39",
    "start": "2026-09-21",
  ...
  "board": {
    ...
    "summary": "Captured 7 origin/main commits after yesterday's 00:04 UTC log (PR #28, af6ab11) which had stopped at 8ea7c1d. Head now ea68046 (2026-09-22 14:15 -0500). Hub 1.8.40\u21921.8.42; viewer.html v2.10.19\u2192v2.10.20; live-viewer stays 1.1.11. cameras/json 12\u219213; drone 134\u2192133; responder-drone 137\u2192136. Empty Publish Responder Intel (a06c776). ER v6.8.20, golf v1.0.4, Nearmap review v1.7.18 / viewer v1.1.16. ISO week 2026-W39 now includes these ships.",
    "as_of": "2026-09-23",
    "last_write": "2026-09-23 00:04 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-23"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-23 (was 20 on 2026-08-25)"
      },
      {
        "label": "Ranked open items",
        "value": "17",
        "sub": "still open of 18 listed",
        "evidence": "2026-08-25 board. Original 18-item list is not in this clone; no evidence those items closed. Recount 2026-09-23 unchanged."
      },
      {
        "label": "EagleView access",
        "value": "Not granted",
        "sub": "30-day eval clock has not started",
        "evidence": "2026-08-25 board; no grant file in this checkout. Recount 2026-09-23 unchanged."
      }
    ],
    "pipelines": [
      {
