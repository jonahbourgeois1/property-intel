window.PI_STATUS = {
  "as_of": "2026-08-28",
  "as_of_utc": "2026-08-28T00:13:41Z",
  "repo": "jonahbourgeois1/property-intel",
  "ref": "origin/main",
  "head": {
    "sha": "606537c9a07b5d990d5111d74f6f0dfd98830dea",
    "short": "606537c",
    "message": "Merge main drone-test sync before Pages publish.",
    "author_date": "2026-08-27T21:53:13Z"
  },
  "sources": {
    "git_log_since": "2026-08-27",
    "iso_week": "2026-W35",
    "changelog": null,
    "context": null,
    "property_intel_v2": "404 from this token; OneDrive v2 docs/ops not mounted",
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-08-28 cannot hide today"
  },
  "weekly": {
    "label": "2026-W35",
    "start": "2026-08-24",
    ...
    "still_open": [
      {
        ...
        "evidence": "list-cloud-agents returned this cron, 8/27, 8/26 Log Bot runs plus internal Summarize yesterday log bot"
      },
      {
        "item": "Daily log PR #1 still DRAFT; docs/ops/ not on main",
        "evidence": "gh pr list: #1 cursor/property-intel-daily-log-4f45 DRAFT; origin/main has no docs/ops"
      }
    ],
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. satellite.gs copied in 1f02d1b; more .gs copies in 9a754fb. No satellite.gs deploy evidence on 2026-08-28; MOCKINGBIRD row 277 is the first check after a real deploy.",
      "Public data/*.json is sync-owned (drone-test + Eugene row + camera JSON on 2026-08-27).",
