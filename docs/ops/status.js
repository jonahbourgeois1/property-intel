window.PI_STATUS = {
  "as_of": "2026-09-16",
  "as_of_utc": "2026-09-16T00:22:45Z",
  ...
  "sources": {
    ...
    "note": "index.html embeds this snapshot so a stale sibling status.js without ## 2026-09-16 cannot hide today"
  },
  "weekly": {
    "label": "2026-W38",
    "start": "2026-09-14",
    ...
    "watchouts": [
      "Apps Script editor-save is not a new deployment; .gs copies in git are not a deploy. 144cfec copied drone-test.gs, first records.gs, and shared.gs. nearmap.gs last copy remains 07b62a1; config.gs last Nearmap copy remains 4937ac0. satellite.gs last copy remains d688a65; no satellite.gs copy after that. MOCKINGBIRD row 277 is the first check after a real satellite.gs deploy.",
      "Public data/*.json is sync-owned. Last Sync/Publish on origin/main is 0c70e0e Sync Drone (empty tree after 0bffe00 wrote six new data/drone/{id}.json; drone 128\u2192134). 160525a/c124c0e touched existing responder-drone files (count stays 137). Nearmap JSON unchanged after 542bd09. No satellite/plane Sync/Publish. Recount 2026-09-16: satellite 506, plane 22, drone 134, drone-test 3, lane tiles 332, gis 3, hoa 5, responder-drone 137, nearmap 1, cameras/json 3.",
    ...
    "pipelines": [
      ...
      },
      {
        ...
        "status": "last Sync/Publish 2026-09-15 drone + responder-drone",
        "evidence": "0bffe00 added six data/drone/{id}.json (128\u2192134). 144cfec added one drone-test JSON (2\u21923). c124c0e/160525a updated existing responder-drone files (count stays 137). 0c70e0e/b932d36 empty after 0bffe00. 542bd09 remains the Nearmap JSON write. No satellite/plane Sync/Publish. Editor-save is not a deploy."
      },
      {
        "id": "satellite",
        "name": "Satellite Pass 1 / review / Pass 2",
        "status": "viewers on main; deploy unverified",
        "evidence": "element-review.html BUILD v6.8.20 unchanged after 0c70e0e. satellite.gs copy last changed in d688a65; file copy is not a deploy. No satellite.gs copy 2026-09-03..2026-09-16."
      },
      {
        "id": "nearmap",
      ...
      },
      {
        ...
        "name": "Photo intake",
        "status": "not in this clone",
        "evidence": "no photo-intake source in this v1 checkout. c65c8b1 NEXT_SESSION names intake as the 2026-09-16 planned session; that is a brief, not a ship of the transport."
      }
    ],
    "in_progress": [
      {
  ...
  "board": {
    ...
    "summary": "After the 9/15 cron: hub 1.8.22\u21921.8.25 live cameras (d61f2e1\u2026b2785c3), Gud Cultures drone-test (144cfec; drone-test 2\u21923), Sync Drone six new records (0bffe00; 128\u2192134), responder-drone edits (count stays 137), and docs/audit maps (33 current / 12 planned). ER v6.8.20, golf v1.0.4, Nearmap review v1.7.18 / viewer v1.1.16 unchanged. ISO week 2026-W38. Lane 332; satellite 506; plane 22; nearmap 1; responder-drone 137. completion % null. Photo transport and EagleView access still block scale-out (no new evidence).",
    "as_of": "2026-09-16",
    "last_write": "2026-09-16 00:22 UTC",
    ...
    "kpis": [
      {
        ...
        "evidence": "len(data/satellite/*.json)=506 recount 2026-09-16"
      },
      {
        "label": "Plane-rendered properties",
        "value": "22",
        "sub": "target 44 Highlands roster",
        "evidence": "len(data/plane/*.json)=22 recount 2026-09-16 (was 20 on 2026-08-25)"
      },
      {
        "label": "Ranked open items",
        "value": "17",
        "sub": "still open of 18 listed",
        "evidence": "2026-08-25 board. Original 18-item list is not in this clone; no evidence those items closed. Recount 2026-09-16 unchanged."
      },
      {
        "label": "EagleView access",
        "value": "Not granted",
        "sub": "30-day eval clock has not started",
        "evidence": "2026-08-25 board; no grant file in this checkout. Recount 2026-09-16 unchanged."
      }
    ],
    "pipelines": [
      {
        ...
        "items": [
          {
            ...
            "note": "Zoho Forms closed. Creator probe 2 ready; fallback own page + S3 presigned POST. c65c8b1 names intake as the 2026-09-16 planned session; that brief is not a transport ship."
          },
          {
            "status": "blocked",
            "label": "BLOCKED",
            "title": "EagleView access",
            "note": "Not granted. 30-day eval clock has not started. License rights (analyze/cache/derive/resell) and 3D-mesh questions first. No grant file in this checkout."
          }
        ]
      }
    ]
