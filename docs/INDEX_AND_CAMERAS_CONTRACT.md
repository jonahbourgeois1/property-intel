...
**Estimated pins (2026-09-21):** the same `estimated-nadir` placement, from the parcel nadir only (no live-wall check), is on Bend `744a3639…`, Matt King `282006d9…`, Butler `305a4423…`, PPS `135df629…`, Albany `757c8b82…`, Sutherlin `f34caa15…`, Roseburg `a06c4a93…`, Myrtle Creek `6d70b38e…`, Grants Pass `bdbd4a55…`, and Central Point `2162ec07…`. Matt King uses the Phoenix Hills nadir; the four feeds are the same CHEKT site as Bend. Butler’s render has no `nadir.bounds`, so those lat/lng use the taxlot box; they show on 2D and stay off the 3D model until a render writes `nadir.bounds` and `nadir.local`. Tracy `2dce25a3…` reads the Jones GPS file `6de88883…` through `CAMERA_HUB_SIBLINGS` (same house).
