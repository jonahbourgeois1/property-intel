...
- Nearmap (trial) → `nearmap-viewer.html?embed=1&delivery=…` nested under Private when `NEARMAP_DELIVERY_HUB` maps this hub (or `?delivery=` / later `views.nearmap`)
